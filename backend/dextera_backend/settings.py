"""
Django settings for dextera_backend project.
...
ROOT_URLCONF = 'dextera_backend.urls'
...
WSGI_APPLICATION = 'dextera_backend.wsgi.application'
...
# Media files (for storing uploaded data of user )
